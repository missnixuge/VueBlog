            ...
            <article class="newhome">
                <div class="page about">
                    <div class="about-body">
                        <div class="title">
                            <el-divider content-position="center" data-aos="zoom-in"><span class="message-divider">{{website.title}}</span></el-divider>
                        ...
                        <div class="introduce" data-aos="flip-right">
                            ...
                            <div class="field-box">
                                <p>一直以来，无论在学上中，还是毕业从业中，我早已养成了收藏的习惯，但凡遇到了有营养的好文章，或者从业中遇到问题，百度到答案后，我都会随手保存到word中，
                                    ...
                                    搭建一个属于自己的博客便在内心油然而生，它将是我用来记录从业中解决BUG的垫脚石，生活上的美文共享，一句话来领悟人生真谛，于是我暂时放弃了手头上正在整理的.NETCORE框架，
                                    转而搭建{{website.title}}，最后本站就这样诞生了。</p>
                                <p>
                                    <span style="font-style:italic">特殊说明：</span>在这里面你可能会看到众多博客的元素，没错，你的眼睛是雪亮的，前期为了找页面设计灵感，我浏览了众多优秀的博客，有H5、VUE等等，我为了节约时间，
                                ...
                                <h1>开发环境</h1>
                                <p><span class="text-bold">前端：</span>前端页面纯使用VUE + VUEX + ElementUI框架，请求使用axios，路由使用vue-router，及其他优秀小插件完成，虽然过程有点艰苦，不过结果还是挺好的。</p>
                                <p><span class="text-bold">后端：</span>网站采用.NETCORE作为后台框架，基于Jwt实现鉴权体系，使用mysql8数据库进行搭建！
                                小站艰难的生存着。后续将会继续完善功能和页面的优化！若浏览过程中发现Bug，欢迎
...
export default {
    ...
    methods: {
        init(page) {
            this.$api.get("Blog/version",null,res => {
